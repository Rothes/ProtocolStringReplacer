...
public class ProtocolStringReplacer extends JavaPlugin {
    ...
    private void checkConfig() {
        CommentYamlConfiguration configDefault = CommentYamlConfiguration.loadConfiguration(new InputStreamReader(instance.getResource("Config.yml"), StandardCharsets.UTF_8));
